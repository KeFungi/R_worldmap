...
data_tb <-  #fake data
  tibble(sample=paste0("s", 1:50), Long=runif(50, -180, 180), Lat=runif(50, -90, 90), status=sample(c("complete", "incomplete"), 50, TRUE))

mapWorld <-  #world map, x-cordinate=longitude, y-cordinate=latitude
